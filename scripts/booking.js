...
function showBookingSuccess(nombre, tratamiento, fecha, hora) {
    ...
    if(successDiv){
        ...
        var successHTML = '<div style="background:rgba(0,0,0,0.15);border-radius:16px;padding:28px 24px 120px 24px !important;max-width:550px;margin:0 auto;text-align:center">';
        ...
        successHTML += '<button id="saveCalendarBtn" class="btn-primary" style="background:white;color:#A8864F;padding:12px 24px;font-size:0.9rem;border-radius:50px;border:none;box-shadow:0 2px 8px rgba(0,0,0,0.2);cursor:pointer;display:block;margin:0 auto 40px auto !important">📅 Guardar en Google Calendar</button>';
