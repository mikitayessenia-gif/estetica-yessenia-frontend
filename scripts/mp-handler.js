        ...
        .then(function(data) {
            ...
            if (data.estado === 'Reservado') {
                ...
                if (senaDiv2) {
                    ...
                    var successHtml = '<div style="background:rgba(255,255,255,0.08);border-radius:16px;padding:28px 24px 32px 24px;max-width:550px;margin:0 auto;text-align:center">'
