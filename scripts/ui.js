...
function showExitConfirmationModal() {
    ...
    document.getElementById('exitStayBtn').addEventListener('click', function() {
        ...
        window.scrollTo({top: document.getElementById('reservar') ? document.getElementById('reservar').offsetTop - 100 : 0, behavior:'smooth'});
    });
...
function interceptBookingNavigation() {
    ...
    var observer = new MutationObserver(function() {
        if (window._senaTimerId && document.getElementById('reservar')) {
